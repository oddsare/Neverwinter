---
status: ACTIVE — slow-burn campaign plot
type: quest / multi-tier campaign arc
campaign-role: Tier 1-3 political spine; intersects the Shadowy Force investigation
tags: [quest, alagondar, claugiyliamatar, succession, political, multi-tier, foster-king]
---

# The Foster King

> A boy in a remote estate. A loving mother who is not what she seems. A throne stolen 74 years ago. A dragon who plays the long game.
...
## The Uncertainty — This Is the Engine

**Claug only SUSPECTS.** She does not have proof. The genealogy is suggestive but incomplete. She has been raising him on a hypothesis.

This means:
- He might not be Alagondar at all. The vaults might not open. She has invested 20 years in a dead end.
- He might be — and the proof exists somewhere in Indrina's surviving notes.
- Someone else (the [[Factions/The Harpers|Harpers]], Renaer's intelligence apparatus, a rival Alagondar pretender) might prove or disprove the lineage first.

**The party can be the ones who discover the truth.** That is the tier 2 turning point.

## The Three-Faction Map (per [[Lore/3 Faction Rule]])

Applied to the succession conflict:
...
- **The party's central choice:**
  ...
  - **Expose Claug to Aldric.** He must choose: his mother or his city. Could go any direction. He might break and refuse the throne. He might side with her and become a tyrant. He might kill her — or be killed by her.
  - **Kill Claug before the coronation.** Aldric becomes king as an orphan a second time, hating the party who took his mother from him. He may rule well or poorly.
  - **Discredit Aldric's claim.** The bloodline is denied (or the genealogy buried). Renaer keeps the throne. Aldric is broken. Claug loses twenty years of work and goes feral with rage — and the party are her targets.
  - **Save Aldric from Claug without exposing her.** Spirit him away. He renounces the throne. Renaer keeps power. Claug hunts the party forever.

## Renaer's Fate — Player-Driven

Per the user's lock: Renaer's fate is whatever the players make of it across the campaign. Possible endpoints:

- **Discredited and exiled** — Indrina's dossier goes public, Renaer is forced out
- **Persuaded to abdicate** — party convinces him his blood is fake and the city deserves a true heir
- **Killed in a Sons of Alagondar coup** — which the party may or may not support
- **Assassinated by Claug's agents** — clearing the field for Aldric
- **Kept in power** — party suppresses the heir, buries the dossier, lets the lie stand for stability
- **Becomes Aldric's regent or chancellor** — party brokers a coexistence

**DM should not pre-decide.** Each tier's events compound toward whichever ending the party drives.

## Indrina Lamsensettle — the Linchpin NPC

See [[NPCs/Indrina Lamsensettle]] for the canonical figure.

Her genealogy dossier is the artifact this entire plot depends on:

- **Claug obtained a copy or summary** — possibly commissioned Indrina decades ago under a false noble identity ("Lady Maeve" prototype?), possibly stole it after the dossier was assembled, possibly intercepted a Harper courier carrying it.
- **The original dossier still exists** with Indrina, the Harpers, or in a Waterdhavian vault.
- **The full dossier likely identifies multiple possible heirs.** Aldric is one. Others may exist that Claug doesn't have. *(Recommended: yes — adds a rival-heir subplot for tier 2-3.)*

If the party finds Indrina or her dossier, they get the truth of Aldric's blood **and** the names of other potential claimants. Huge tier-2 reveal.

**Recommended Indrina status:** alive, in hiding, dossier intact, terrified — per the [[NPCs/Indrina Lamsensettle|Indrina file's recommendation]].

## Hooks into Other Plots

- **[[Quests/The Shadowy Force]]:** if Claug's Neverwinter operations include suppressing investigations near the Vance estate (or in the orphanages she sourced Aldric from), then disappearances along certain trade routes lead the party right to her network. The two plots can share an inciting incident.
- **[[../Quests/Kurtulmak's Chosen - Underground Ascension|Kurtulmak's Chosen]]:** the underground Chosen wants to become "more than kobold." Claug wants to become "more than dragon." Aldric is being made into "more than orphan." Three transformations on parallel timelines. Pure thematic resonance.
- **[[NPCs/Voaraghamanthar - Two Black Brothers|Two Black Brothers]]:** the Twin Crowns of Miramaran grant immunity to mind-manipulation. If Claug obtains or borrows one, she could shield Aldric from Harper diviners trying to expose his "mother." Crossover plot point.
- **[[NPCs/Selune and Shar - Sister Goddesses|Sharran cult]]:** Shar specializes in transformation and identity-unmaking. A Sharran ritualist may be the one helping Claug groom Aldric's identity — and may be the one who'd ultimately help her body-swap or merge with him at the throne moment. Dark variant.
- **[[Factions/Arcane Brotherhood|Arcane Brotherhood]]:** Brotherhood mages may be the ones secretly tutoring Aldric in advanced magic on Claug's payroll. They think they're playing her; they aren't.
...
- [[NPCs/Claugiyliamatar - Old Gnawbone]]
- [[NPCs/Indrina Lamsensettle]]
- [[NPCs/Renaer Neverember]]
- [[NPCs/Dagult Neverember]]
- [[Lore/The Alagondar Dynasty]]
- [[Lore/The Lost Crown and Hidden Alagondar Vaults]]
- [[Lore/3 Faction Rule]]
- [[Quests/The Shadowy Force]]
- [[../Quests/Kurtulmak's Chosen - Underground Ascension]]
